...
\item Let $\#(Sub(\varphi_{0})) \leq \#(T(\varphi_{0}))$ and
  ...
  $\#(Sub(\varphi_{0} \square \varphi_{1})) \leq \#(Sub(\varphi_{0})) + \#(Sub(\varphi_{1})) + 1$
  and
  $\#(T(\varphi_{0} \square \varphi_{1})) = \#(T(\varphi_{0})) + \#(T(\varphi_{1})) + 1$.
  So clearly, $\#(Sub(\varphi_{0} \square \varphi_{1})) \leq \#(T(\varphi_{0} \square \varphi_{1}))$.
\item $\#(Sub(\varphi)) \leq \#(T(\varphi)) \Rightarrow \#(Sub(\neg \varphi)) \leq \#(T(\neg \varphi))$,
  since $\#(Sub(\neg \varphi)) = \#(Sub(\varphi)) + 1$ and $\#(T(\neg \varphi)) = \#(T(\varphi)) + 1$.
\end{list}

\item % 8c
Notation: $depth(\varphi)$ is the length of a longest branch in $T(\varphi)$. We show $r(\varphi) = depth(\varphi)$
...
\item $\varphi = \varphi_{0} \square \varphi_{1}$ with $r(\varphi_{0}), r(\varphi_{1}) < r(\varphi)$ (from
  exercise 6d). Now $depth(\varphi) = max(depth(\varphi_{0}), depth(\varphi_{1})) + 1$ and by definition
  $r(\varphi) = max(r(\varphi_{0}), r(\varphi_{1})) + 1$. This shows $r(\varphi) = depth(\varphi)$.
\item Like (ii).
\end{list}
...
\item Let $\#(T(\varphi)) \leq 2^{r(\varphi)+1}-1$ and $\#(T(\psi)) \leq 2^{r(\psi)+1}-1$. By definition,
  $\#(T(\varphi \square \psi)) = \#(T(\varphi)) + \#(T(\psi)) + 1$, so
  $\#(T(\varphi \square \psi)) \leq  2^{r(\varphi)+1} + 2^{r(\psi)+1} - 2$ and thus
  $\#(T(\varphi \square \psi)) \leq  2^{max(r(\varphi)+1,r(\psi)+1)+1} - 2$ (by $2^{x} + 2^{y} \leq 2^{max(x,y)+1}$).
  Now, $2^{r(\varphi \square \psi)+1}-1 = 2^{max(r(\varphi),r(\psi))+2}-1$. Clearly,
  $\#(T(\varphi \square \psi)) \leq  2^{max(r(\varphi),r(\psi))+2} - 1$.
\item Like (ii).
\end{list}
TODO: Finish with conclusion (using 8a).
