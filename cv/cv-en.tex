...
\hspace{7em}\begin{tabular}{p{12em}l}
  Turnerstraat 7hs  & Phone: +31 6 409 202 76\\
  1076 VA           & E-mail: \href{mailto:martijn@vermaat.name}{\texttt{martijn@vermaat.name}}\\
  Amsterdam         &
\end{tabular}
...
\item[8/2002 -- present]
  ...
  \begin{sublist}
  \item Expected graduation August 2010
  \item Master Thesis: \textit{Infinitary Rewriting in Coq}
...
\item[2010]
  {\bf Teaching Assistant Logical Verification}\\
  Vrije Universiteit, Amsterdam
  \begin{sublist}
  \item Type theory, logic, functional programming, verification
  \item Installment 2010
  \end{sublist}
\item[2005 -- 2009]
  {\bf Teaching Assistant Introduction to Theoretical Computer Science}\\
  Vrije Universiteit, Amsterdam
  \begin{sublist}
  \item $\lambda$-calculus, equational logic, functional programming
  \item Installments 2005, 2006, 2007, 2008, 2009
  \end{sublist}
\item[2005 -- 2009]
  {\bf Teaching Assistant Introduction to Logic}\\
  Vrije Universiteit, Amsterdam
  \begin{sublist}
...
\item
  {\bf Proficient}\\
  Java, OCaml, Coq, Python, Stratego/XT, \LaTeX, PHP, Javascript
\item
  {\bf Familiar}\\
  C, Perl, Haskell, Prolog, Bash, XSLT, SQL
\end{cvlist}
...
\begin{cvlist}{Attachment 1}
  ...
  \begin{tabular}{p{23em}d}
    ...
    Neural Networks & 8\\
    Recursion Theory (University of Amsterdam) & 10\\
