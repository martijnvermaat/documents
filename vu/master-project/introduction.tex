...
understood as a term with a \emph{possibly} infinite depth, that is,
the class of infinite terms includes the finite terms.
...
by a machine. Scriblings on paper or ideas in one's head do not
...
\begin{asparadesc}
  \item[\normalfont{\emph{Increase of confidence}}\hskip .5em]
    Errors in proofs or inconsistencies in theories may be detected by
    the computer. This increases confidence in their correctness.
  \item[\normalfont{\emph{Automation}}\hskip .5em]
    Tedious work, whether computationally hard or just boring, is
    often better suited for computers. They are faster than humans and
    precise.
  \item[\normalfont{\emph{Insight}}\hskip .5em]
    Formalised theories might help gain insights and intuition because
    they necessarily include all levels of detail.
\end{asparadesc}
