...
Rewrite sequences as functions from ordinals to steps vs inductive
definition.

Restriction to rewrite sequences of length $\le \omega$.
...
\coqdocvariable{s} $\rewrites_\mathcal{R}$
