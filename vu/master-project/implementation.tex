...
TODO: definitions for subterm, fill and dig
...
Again, let throughout this section $\mathcal{R}$ be a fixed TRS.

TODO: text for this section
TODO: definitions of left-linearity (term, trs)

% TODO: define position somewhere (and link to it)
% TODO: define subterm, fill and dig
\begin{singlespace}
\begin{coqdoccode}
\coqdocnoindent
\coqdockw{Definition}
...
(\coqref{Rewriting.lhs}{\coqdocprojection{lhs}}
\coqdocvariable{$\rho_1$})$^{\coqdocvariable{$\sigma$}}$[$\Box$]$_{\coqdocvariable{p}}$
...
\coqdocindent{1.00em}
\ensuremath{\lnot} \ensuremath{\exists} \coqdocvar{c} : \coqdocinductive{context},
