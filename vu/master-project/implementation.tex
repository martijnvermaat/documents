...
$\twoheadrightarrow_\mathcal{R}$ \coqdocvar{t} $\rightarrow$
\coqdocvariable{t} $\rightarrow_\mathcal{R}$ \coqdocvar{u} $\rightarrow$
\coqdocvariable{s} $\twoheadrightarrow_\mathcal{R}$
\coqdocvariable{u}\coqdoceol
\coqdocindent{1.00em}
...
\ensuremath{\forall} \coqdocvar{s} \coqdocvar{t},
(\coqexternalref{http://coq.inria.fr/stdlib/Coq.Init.Datatypes}{nat}{\coqdocinductive{nat}}
\ensuremath{\rightarrow} \coqdocvariable{s} $\twoheadrightarrow_\mathcal{R}$
\textbf{?}) $\rightarrow$
\coqdocvariable{s} $\twoheadrightarrow_\mathcal{R}$
\coqdocvariable{t}.\coqdoceol
\end{coqdoccode}
...
\textbf{?}. We complete the type for
...
$\twoheadrightarrow_\mathcal{R}$ \coqdocvar{ts} \coqdocvariable{n})
$\rightarrow$
