...
% TODO: cite color and coccinelle
...
% TODO: perhaps this should be in the appendix?
...
the case. Consider the analoguous example of finite lists. They can be
naturally represented inductively, without the need for a
representation of natural numbers. Likewise, we now study the
definition of tree ordinals that is lifted to a definition of
transfinite rewrite sequences in Section~\ref{sec:seq}.
...
\end{coqdoccode}
\end{singlespace}
In fact, all definitions from Section~\ref{sub:tree} translate directly to
...
Recalling our discussion in Section~\ref{sub:tree} of limit ordinals whose
...
% TODO: equivalent to Leibniz' equality
