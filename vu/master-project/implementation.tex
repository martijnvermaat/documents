...
\coqdocindent{2.00em}
\ensuremath{\forall} \coqdocvar{d}, \ensuremath{\exists}
\coqdocvar{i}, \ensuremath{\forall} \coqdocvar{j},\coqdoceol
\coqdocindent{3.00em}
\coqdocvariable{$\varphi$}[\coqdocvar{seq} \coqdocvariable{i}]
\ensuremath{\le} \coqdocvariable{$\varphi$}[\coqdocvar{seq}
  \coqdocvariable{j}] \ensuremath{\rightarrow}\coqdoceol
\coqdocindent{3.00em}
(\coqref{Rewriting.depth}{\coqdocdefinition{depth}}
(\coqdocvariable{$\varphi$}[\coqdocvar{stp} \coqdocvariable{j}]) >
\coqdocvariable{d})\%nat\coqdoceol
\coqdocindent{1.00em}
\coqdockw{end}.\coqdoceol
\end{coqdoccode}
\end{singlespace}
