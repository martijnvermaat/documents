...
In this chapter we present our formalisation of infinitary rewriting
in the \Coq proof assistant. Section~\ref{sec:ordimp} translates the
Brouwer ordinals from Section~\ref{sub:brouwer} to \Coq. Coinductive
...
based on the structure of the Brouwer ordinals. We start with a short
introduction to \Coq in Section~\ref{sec:coq}.

Large scale mechanical formalisation of mathematics goes back to the
late 1960s with de Bruijn's \Automath project
\citep{nederpelt-94}. A full text book on Analysis \citep{landau-65}
was formalised and verified for correctness in \Automath.

We name a few formalisations that have since been undertaken. The four
colour theorem (Gonthier). TODO.

Related to our formalisation of infinitary rewriting are \CoLoR, TODO.
...
of the Brouwer ordinal $\alpha$. Much of the definitions on ordinals
