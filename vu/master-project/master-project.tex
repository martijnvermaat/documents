...
% TODO: do we use pure ascii coq, or add readable notations?
% e.g. \arrow{} vs ->
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Inductive} \coqdef{ja.ord}{ord}{\coqdocinductive{ord}} :
\coqdockw{Set} :=\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|} \coqdef{ja.Zero}{Zero}{\coqdocconstructor{Zero}}  :
\coqref{ja.ord}{\coqdocinductive{ord}}\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|} \coqdef{ja.Succ}{Succ}{\coqdocconstructor{Succ}}  :
\coqref{ja.ord}{\coqdocinductive{ord}} \ensuremath{\rightarrow}
\coqref{ja.ord}{\coqdocinductive{ord}}\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|} \coqdef{ja.Limit}{Limit}{\coqdocconstructor{Limit}} :
