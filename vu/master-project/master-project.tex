...
rewriting, consult~\cite{terese-03} (TODO: others). In this section, we use
definitions and notations from Terese.
...
Normal forms, left-linearity, critical pairs, etc.
...
%Again, we
%identify ordinals and their representation as Brouwer ordinal (and by $^+$ we
%no longer mean the set-theoretic abbreviation defined above).
...
% TODO: we can also skip finitary rewriting and only define infinitary
% rewriting
% TODO: some informal motivation for infinitary rewriting

We present infinitary term rewriting as a generalization of finitary term
rewriting as defined in section~\ref{sec:trs}.
