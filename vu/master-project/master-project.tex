...
We define the ordinal numbers in Coq using the representation of Brouwer
ordinals:
\begin{singlespace}
\begin{coqdoccode}
\coqdocnoindent
...
\coqdocnoindent
\coqdockw{Inductive}
\coqdef{Ordinal.ordle}{ord\_le}{\coqdocinductive{\ensuremath{\le}}} :
\coqref{Ordinal.ord}{\coqdocinductive{ord}} \ensuremath{\rightarrow}
\coqref{Ordinal.ord}{\coqdocinductive{ord}} \ensuremath{\rightarrow}
\coqdockw{Prop} :=\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|}
\coqdef{Ordinal.OrdleZero}{Ord\_le\_Zero}{\coqdocconstructor{\ensuremath{\le_{\text{Zero}}}}}
: \ensuremath{\forall} \coqdocvar{\ensuremath{\alpha}},
\coqref{Ordinal.Zero}{\coqdocconstructor{Zero}} \coqref{Ordinal.ordle}{\coqdocinductive{\ensuremath{\le}}}
\coqdocvariable{\ensuremath{\alpha}}\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|}
\coqdef{Ordinal.OrdleSucc}{Ord\_le\_Succ}{\coqdocconstructor{\ensuremath{\le_{\text{Succ}}}}}
: \ensuremath{\forall} \coqdocvar{\ensuremath{\alpha}} \coqdocvar{\ensuremath{\beta}}
\coqdocvar{i},
\coqdocvariable{\ensuremath{\alpha}} \coqref{Ordinal.ordle}{\coqdocinductive{\ensuremath{\le}}}
\coqdocvariable{\ensuremath{\beta}}[\coqdocvariable{i}] \ensuremath{\rightarrow}
\coqref{Ordinal.Succ}{\coqdocconstructor{Succ}} \coqdocvariable{\ensuremath{\alpha}}
\coqref{Ordinal.ordle}{\coqdocinductive{\ensuremath{\le}}} \coqdocvariable{\ensuremath{\beta}}\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|}
\coqdef{Ordinal.OrdleLimit}{Ord\_le\_Limit}{\coqdocconstructor{\ensuremath{\le_{\text{Limit}}}}}
: \ensuremath{\forall} \coqdocvar{f} \coqdocvar{\ensuremath{\beta}},
(\ensuremath{\forall} \coqdocvar{n}, \coqdocvariable{f} \coqdocvariable{n}
\coqref{Ordinal.ordle}{\coqdocinductive{\ensuremath{\le}}} \coqdocvariable{\ensuremath{\beta}}) \ensuremath{\rightarrow}
\coqref{Ordinal.Limit}{\coqdocconstructor{Limit}} \coqdocvariable{f}
\coqref{Ordinal.ordle}{\coqdocinductive{\ensuremath{\le}}} \coqdocvariable{\ensuremath{\beta}}.\coqdoceol
\end{singlespace}
