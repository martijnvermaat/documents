...
The \coqref{Ordinal.ord}{\coqdocinductive{ord}} datatype defines the Brouwer
ordinals:
...
\coqdocnoindent
\coqdockw{Fixpoint}
\coqdef{Ordinal.predtype}{pred\_type}{\coqdocdefinition{pred\_type}}
(\coqdocvar{alpha} : \coqref{Ordinal.ord}{\coqdocinductive{ord}}) :
\coqdockw{Set} :=\coqdoceol
\coqdocindent{1.00em}
\coqdockw{match} \coqdocvariable{alpha} \coqdockw{with}\coqdoceol
\coqdocindent{1.00em}
...
\coqdocvar{alpha} \ensuremath{\Rightarrow}
(\coqexternalref{http://coq.inria.fr/stdlib/Coq.Init.Datatypes}{unit}{\coqdocinductive{unit}}
+ \coqref{Ordinal.predtype}{\coqdocdefinition{pred\_type}}
\coqdocvariable{alpha}) \% \coqdocvar{type}\coqdoceol
\coqdocindent{1.00em}
...
\begin{singlespace}
\coqdocnoindent
\coqdockw{Fixpoint} \coqdef{Ordinal.pred}{pred}{\coqdocdefinition{pred}}
(\coqdocvar{alpha} : \coqref{Ordinal.ord}{\coqdocinductive{ord}}) :
\coqref{Ordinal.predtype}{\coqdocdefinition{pred\_type}}
\coqdocvariable{alpha} \ensuremath{\rightarrow}
\coqref{Ordinal.ord}{\coqdocinductive{ord}} :=\coqdoceol
\coqdocindent{1.00em}
\coqdockw{match} \coqdocvariable{alpha} \coqdockw{with}\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\ensuremath{|} \coqref{Ordinal.Succ}{\coqdocconstructor{Succ}}
\coqdocvar{alpha} \ensuremath{\Rightarrow} \coqdockw{fun} \coqdocvar{i}
\ensuremath{\Rightarrow} \coqdockw{match} \coqdocvariable{i}
...
\coqref{Ordinal.pred}{\coqdocdefinition{pred}} \coqdocvariable{alpha}
\coqdocvariable{t}\coqdoceol
\coqdocindent{13.50em}
\coqdockw{end}\coqdoceol
\coqdocindent{1.00em}
\ensuremath{|} \coqref{Ordinal.Limit}{\coqdocconstructor{Limit}} \coqdocvar{f}
\ensuremath{\Rightarrow} \coqdockw{fun} \coqdocvar{i} \ensuremath{\Rightarrow}
...
\coqdocvar{n} \coqdocvar{t} \ensuremath{\Rightarrow}
\coqref{Ordinal.pred}{\coqdocdefinition{pred}} (\coqdocvariable{f}
