...
Before we formally introduce term rewriting, we give an example of an
infinitary TRS.
...
\citet{klop-de-vrijer-05}. In this section, we try to follow
definitions and notations from \citet{terese-03}, but diverge where
our \Coq formalisation discussed in Chapter~\ref{chap:implementation}
does. % ... does so. ?
...
Compression Lemma.
\begin{lemma}[{\normalfont{Compression}}]\label{thm:compression}
