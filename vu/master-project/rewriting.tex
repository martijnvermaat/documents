...
% TODO: \Ord etc always in math mode (no space is added after it)
...
% should we destinguish between the two?

Of course we have that UN$^\infty$ implies UN$^\twoheadrightarrow$.
% TODO: pictures

\begin{definition}%[Overlap and critical pairs]
...
Critical pairs are unique up to renaming.
...
Orthogonal TRSs have unique normal forms
\citep{kennaway-95,klop-de-vrijer-05}. See Chapter~\ref{chap:unwo} for
