...
\tikzstyle{level}=[level distance=25pt, sibling distance=30pt]
\node (a) {$A$};
...
finitary rewriting, is intuitively well-defined. It is reached by
...
\node (b) [right of=a] {$B$} child { node {$A$} };
\node (c) [right of=b] {$B$} child { node {$B$} child { node {$A$} } };
\node (d) [right of=c,node distance=90pt] {$B$} child { node {$B$} child { node {$B$}
    child { node[below=-8pt] {$\vdots$} } } };
\path (a) -- (b) node[midway,below=-1pt] {$\rightarrow$};
\path (b) -- (c) node[midway,below=-1pt] {$\rightarrow$};
...
\begin{center}
\vspace{0pt}
\begin{tikzpicture}[node distance=45pt]
\tikzstyle{level}=[level distance=25pt, sibling distance=20pt]
...
\node (d) [right of=c,node distance=70pt] {$P$} child { node {$B$} child { node {$B$}
    child { node {$B$} child { node[below=-8pt] {$\vdots$} } } } } child { node {$A$} };
\node (e) [right of=d] {$P$} child { node {$B$} child { node {$B$}
    child { node {$B$} child { node[below=-8pt] {$\vdots$} } } } }
child { node {$B$} child { node {$A$} } };
\node (f) [right of=e] {$P$} child { node {$B$} child { node {$B$}
    child { node {$B$} child { node[below=-8pt] {$\vdots$} } } } }
child { node {$B$} child { node {$B$} child { node {$A$} } } };
\node (g) [right of=f,node distance=70pt] {$P$} child { node {$B$} child { node {$B$}
    child { node {$B$} child { node[below=-8pt] {$\vdots$} } } } }
child { node {$B$} child { node {$B$} child { node {$B$} child {
        node[below=-8pt] {$\vdots$} } } } };
\path (a) -- (b) node[midway,below=-1pt] {$\rightarrow$};
\path (b) -- (c) node[midway,below=-1pt] {$\rightarrow$};
...
\vspace{0pt}
\begin{tikzpicture}[node distance=60pt]
\tikzstyle{level}=[level distance=25pt, sibling distance=28pt]
\node (a) {$P$} child { node {$A$} } child { node {$A$} };
\node (b) [right of=a] {$P$} child { node {$B$} child { node {$A$} } } child { node {$A$} };
...
\node (e) [right of=d] {$P$} child { node {$B$} child { node {$B$}
    child { node {$A$} } } }
child { node {$B$} child { node {$B$} child { node {$A$} } } };
\node (f) [right of=e,node distance=90pt] {$P$} child { node {$B$} child { node {$B$}
    child { node {$B$} child { node[below=-8pt] {$\vdots$} } } } }
child { node {$B$} child { node {$B$} child { node {$B$} child {
        node[below=-8pt] {$\vdots$} } } } };
\path (a) -- (b) node[midway,below=-1pt] {$\rightarrow$};
...
representation for them known as the Brouwer ordinals, and we present
the basic notions from the theory of term rewriting as required in the
