...
administrative redexes. The issues of binding and substitution are addressed
by using higher-order abstract syntax.
...
% equivalence classes of pitt's nominal logic
% higher-order abstract syntax
% combination of nominal logic and de bruijn (locally nameless)
