...
The languages of these transformations are realistic functional languages,
...
This is particularly original in that earlier work only considers pure
$\lambda$-calculus.

Binding of variables is represented using de Bruijn notation, hereby omitting
...
substitution.
Also, terms in de Bruijn notation are arguably harder to deal with for humans
than terms with named variables.
...
introduction of continuation variables.

Big-step operational semantics. Bla!
