...
The transformation described in section~\ref{sec:transformation} has been
implemented and verified by Dargaye and Leroy using
the Coq proof assistent \cite{Dargaye-Leroy-07}.
