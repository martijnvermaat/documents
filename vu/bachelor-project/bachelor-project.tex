...
\newtheorem*{mainlemma}{\sffamily Lemma 3}
...
% Don't use eqnarray
% Explain lifting
% Check for \lambda_{0} instead of \lambda^{0}
% Give appropriate references to Dargaye and Leroy
% Cite only works really read?
...
% Check how this compares to Plotkin's proof
...
important properties of the transformation.
...
\end{lemma}
\begin{proof}
By structural induction over $M$ and case analysis over $A$:
\begin{description}
...
lemma~\ref{lem:kappaclosed}). Also, we use the fact $\Uparrow_{x}^{n} \Psi(A) = \Psi(\Uparrow_{x}^{n} A)$
several times. First, a structural induction argument over $M$:
\begin{description}
\item[\sffamily Base case $M = x_{i}$]\hfill
...
\item[\sffamily Inductive case $M = \lambda^{m}.M_{1}$]\hfill
  ...
  \begin{eqnarray*} % TODO: figure out how to do this without eqnarray
    ...
    & = & [\![\lambda^{m}.M_{1}\{x_{0}, \ldots, x_{m}, \Uparrow_{x}^{m+1}A_{1}, \ldots, \Uparrow_{x}^{m+1}A_{n}\}]\!] \\
    & = & \lambda^{0}.\kappa_{0}(\lambda^{m+1}.[\![M_{1}\{x_{0}, \ldots, x_{m}, \Uparrow_{x}^{m+1}A_{1}, \ldots, \Uparrow_{x}^{m+1}A_{n}\}]\!](\kappa_{0})) \\
    & = & \lambda^{0}.\kappa_{0}(\lambda^{m+1}.[\![M_{1}]\!]\{\}\{x_{0}, \ldots, x_{m}, \Uparrow_{x}^{m+1}\Psi(A_{1}), \ldots, \Uparrow_{x}^{m+1}\Psi(A_{n})\}(\kappa_{0})) \\
...
\item[\sffamily Inductive case $M = M_{1}(N_{0}, \ldots, N_{m})$]\hfill
  ...
  Omitted for brevity.
%  \begin{eqnarray*} % TODO: use m instead of n
%    &   & [\![M_{1}(N_{0}, \ldots, N_{n})\{A_{1}, \ldots, A_{n}\}]\!] \\
%    & = & [\![M_{1}\{A_{1}, \ldots, A_{n}\}(N_{0}\{A_{1}, \ldots, A_{n}\}, \ldots, N_{n}\{A_{1}, \ldots, A_{n}\})]\!] \\
%    & = & \lambda^{0}.[\![M_{1}\{A_{1}, \ldots, A_{n}\}.N_{0}\{A_{1}, \ldots, A_{n}\} \ldots N_{n}\{A_{1}, \ldots, A_{n}\} \: \kw{then} \: \kappa_{n+1}(\kappa_{n+2}, \kappa_{n}, \ldots, \kappa_{0})]\!] \\
%    & = & \lambda^{0}.[\![M_{1}\{A_{1}, \ldots, A_{n}\}]\!](\lambda^{0}.[\![N_{0}\{A_{1}, \ldots, A_{n}\}]\!](\lambda_{0}. \ldots [\![N_{n}\{A_{1}, \ldots, A_{n}\}]\!](\lambda^{0}.\kappa_{n+1}(\kappa_{n+2}, \kappa_{n}, \ldots, \kappa_{0})) \cdots )) \\
%    & = & \lambda^{0}.[\![M_{1}]\!]\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\}(\lambda^{0}.[\![N_{n}]\!]\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\}(\lambda^{0}. \ldots [\![N_{0}]\!]\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\}(\lambda^{0}.\kappa_{n+1}(\kappa_{n+2}, \kappa_{n}, \ldots, \kappa_{0})) \cdots )) \\ % IH
%    & = & (\lambda^{0}.[\![M_{1}]\!](\lambda^{0}.[\![N_{n}]\!](\lambda^{0}. \ldots [\![N_{0}]\!](\lambda^{0}.\kappa_{n+1}(\kappa_{n+2}, \kappa_{n}, \ldots, \kappa_{0})) \cdots )))\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\} \\
%    & = & (\lambda^{0}.[\![M_{1}.N_{0} \ldots N_{n} \: \kw{then} \: \kappa_{n+1}(\kappa_{n+2}, \kappa_{n}, \ldots, \kappa_{0})]\!])\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\} \\
%    & = & [\![M_{1}(N_{0}, \ldots, N_{n})]\!]\{\}\{\Psi(A_{1}), \ldots, \Psi(A_{n})\}
%  \end{eqnarray*}
...
\item[\sffamily Inductive case $M = \kw{let} \: M_{1} \: \kw{in} \: M_{2}$]\hfill
  ...
  \begin{eqnarray*} % TODO: figure out how to do this without eqnarray
    ...
    & = & [\![\kw{let} \: M_{1}\{A_{1}, \ldots, A_{n}\} \: \kw{in} \: M_{2}\{x_{0}, \Uparrow_{x}^{1} A_{1}, \ldots, \Uparrow_{x}^{1} A_{n}\}]\!] \\
    & = & \lambda^{0}.[\![M_{1}\{A_{1}, \ldots, A_{n}\}]\!] \\
    &   & \qquad (\lambda^{0}. \: \kw{let} \: \kappa_{0} \: \kw{in} \: [\![M_{2}\{x_{0}, \Uparrow_{x}^{1} A_{1}, \ldots, \Uparrow_{x}^{1} A_{n}\}]\!](\kappa_{1})) \\
...
\item[\sffamily Inductive case $A = \lambda^{m}.M_{1}$]\hfill
  \begin{eqnarray*}
    ...
    & = & \Psi(\lambda^{m}.M_{1}\{x_{0}, \ldots, x_{m}, \Uparrow_{x}^{m+1} A_{1}, \ldots, \Uparrow_{x}^{m+1} A_{n}\}) \\
    & = & \lambda^{m+1}.[\![M_{1}\{x_{0}, \ldots, x_{m}, \Uparrow_{x}^{m+1} A_{1}, \ldots, \Uparrow_{x}^{m+1} A_{n}\}]\!](\kappa_{0}) \\
