...
\frame{
  ...
  Example term: $(\lambda^{0}. \, x_{0}) \, (x_{0})$

  \begin{itemize}
    \item de Bruijn indices
    \item $n$-ary function application
...
\frame{
  ...
  Example evaluation:
  \begin{align*}
    (\lambda^{0}. \, x_{0}) \, (x_{0}) &\Rightarrow x_{0}
  \end{align*}
...
\frame{
  ...
  \begin{itemize}
    \item Two sorts of de Bruijn indices
    \item First argument is bound to $\kappa_{0}$
    \item Big-step operational semantics (next slide)
  \end{itemize}
