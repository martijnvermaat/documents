...
\usepackage[landscape,pdftex,top=.5in,right=.6in,left=.6in,bottom=.5in]{geometry}
...
\begin{equation*}
  \phi(f_{\mathfrak{A}}(a_{1}, \ldots, a_{n})) \equiv f_{\mathfrak{B}}(\phi(a_{1}), \ldots, \phi(a_{n}))
\end{equation*}
