...
\item[($n_2 + 1$)]
  ...
  \begin{equation*}
    \begin{fitch}
      \underline{n_1} \cdot S\underline{n_2} = (\underline{n_1} \cdot \underline{n_2}) + \underline{n_1} & instance $\mathbf{N6}$ \\ % 1
      \underline{n_1} \cdot \underline{n_2} = \underline{m - n_1}                                        & IH \\ % 2
      \underline{n_1} \cdot S\underline{n_2} = \underline{m - n_1} + \underline{n_1}                     & substitution 1, 2 \\ % 3
      \underline{n_1} \cdot S\underline{n_2} = \underline{m}                                             & substitution 3, \textbf{26(iii)} \\ % 4
    \end{fitch}
  \end{equation*}
\end{description}
...
\begin{equation*}
  \begin{fitch}
    \fh \underline{n_1} = x_0 + \underline{n_2}                      & assumption \\ % 1
    \fa \underline{n_1} = x_0 + SS^{n_1}\underline{n_3}               & substitution 1, \textbf{26(iii)} \\ % 2
    \fa \underline{n_1} = SS^{n_1}(x_0 + \underline{n_3})             & $n_1+1$ times substitution with instances of $\mathbf{N4}$ \\ % 3
    \fa \underline{0} = S(x_0 + \underline{n_3})                     & $n_1$ times $\mathbf{MP}$ with instances of $\mathbf{N2}$ \\ % 4
    \fa S(x_0 + \underline{n_3}) = \underline{0}                     & 4, symmetry of $=$ \\ % 5
    \fa S(x_0 + \underline{n_3}) \neq \underline{0}                  & instance $\mathbf{N1}$ \\ % 6
    \fa \bot                                                        & contradiction 5, 6 \\ % 7
    \underline{n_1} \neq x_0 + \underline{n_2}                       & $\neg$ introduction 1-7 \\ % 8
  \end{fitch}
\end{equation*}
...
\item[($n_1 < n_2$)]
  ...
  \begin{equation*}
    \begin{fitch}
      \fh (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} & assumption \\ % 1
      \fa \fh x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2} & assumption \\ % 2
      \fa \fa x_0 = \underline{0} & $\wedge$ elimination 2 \\ % 3
      \fa \fh \underline{n_1} = x_0 + \underline{n_2} & assumption \\ % 4
      \fa \fa \underline{n_1} \neq x_0 + \underline{n_2} & \textbf{26(vi)} \\ % 5
      \fa \fa \bot & contradiction 4, 5 \\ % 6
      \fa \fa x_0 = \underline{0} & $\bot$ elimination 6 \\ % 7
      \fa x_0 = \underline{0} & $\vee$ elimination 1, 2-3, 4-7 \\ % 8
      (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} \rightarrow x_0 = \underline{0} & $\rightarrow$ introduction 1-8 \\ % 9
    \end{fitch}
  \end{equation*}
  \begin{equation*}
    \begin{fitch}
      \fh x_0 = \underline{0} & assumption \\ % 1
      \fa \underline{n_1} < \underline{n_2} & \textbf{26(v)} \\ % 2
      \fa x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2} & $\wedge$ introduction 1, 2 \\ % 3
      \fa (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} & $\vee$ introduction 3 \\ % 4
      x_0 = \underline{0} \rightarrow (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} & $\rightarrow$ introduction 1-4 \\ % 5
    \end{fitch}
  \end{equation*}
...
\item[($n_1 \not< n_2$)]
  ...
  \begin{equation*}
    \begin{fitch}
      \fh (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} & assumption \\ % 1
      \fa \fh x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2} & assumption \\ % 2
      \fa \fa \underline{n_1} < \underline{n_2} & $\wedge$ elimination 2 \\ % 3
      \fa \fa \underline{n_1} \not< \underline{n_2} & \textbf{26(v)} \\ % 4
      \fa \fa \bot  & contradiction 3, 4 \\ % 5
      \fa \fa x_0 = \underline{m} & $\bot$ elimination 5 \\ % 6
      \fa \fh \underline{n_1} = x_0 + \underline{n_2} & assumption \\ % 7
      \fa \fa \underline{n_1} = \underline{m} + \underline{n_2} & \textbf{26(iii)} \\ % 8
      \fa \fa x_0 + \underline{n_2} = \underline{m} + \underline{n_2} & substitution 7, 8 \\ % 9
      ...
      \fa \fa S^{n_2}x_0 = S^{n_2}\underline{m} & two substitutions, using 9, 10, 11 \\ % 12
      \fa \fa x_0 = \underline{m} & $n_2$ times $\mathbf{MP}$ with $\mathbf{N2}$ \\ % 13
      \fa x_0 = \underline{m} & $\vee$ elimination 1, 2-6, 7-13 \\ % 14
      (x_0 = \underline{0} \wedge \underline{n_1} < \underline{n_2}) \vee \underline{n_1} = x_0 + \underline{n_2} \rightarrow x_0 = \underline{m} & $\rightarrow$ introduction 1-14 \\ % 15
    \end{fitch}
  \end{equation*}
  % TODO: last direction
\end{description}
